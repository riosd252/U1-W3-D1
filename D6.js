...
function newString(s1, s2) {
  let string1 = s1.substring(0, 3);
  let string2 = s2.substring(s2.length - 3);

  let concatString = string1.concat(string2).toUpperCase();

  return concatString;
}

console.log(newString("Epicode", "School"));
...
const evenArr = numbersArr.filter((num) => num % 2 === 0);
...
const summedArr1 = evenArr.reduce((num, num1) => num + num1, 0);

console.log(summedArr1);
...
const exe6Array = [2, 5, 20, 8, 13];

const arrayMultiplied = exe6Array.map((n) => n * 2);
